...
const _Conversation_States = Object.freeze({
    ...
    MAIN_MENU: 'MAIN_MENU',
    CLAIM_HUB: 'CLAIM_HUB',
    CLAIM_FARMER_DETAILS: 'CLAIM_FARMER_DETAILS',
    CLAIM_CROP_DETAILS: 'CLAIM_CROP_DETAILS',
    CLAIM_DATE_LOCATION: 'CLAIM_DATE_LOCATION',
    CLAIM_DOCUMENTS: 'CLAIM_DOCUMENTS',
    CLAIM_TEMPLATE_SELECT: 'CLAIM_TEMPLATE_SELECT',
    CLAIM_MISSING_FIELDS: 'CLAIM_MISSING_FIELDS',
    CLAIM_PHOTOS: 'CLAIM_PHOTOS',
    CLAIM_REVIEW: 'CLAIM_REVIEW',
    STATUS_LIST: 'STATUS_LIST',
    STATUS_DETAIL: 'STATUS_DETAIL',
    DRAFT_RESUME_LIST: 'DRAFT_RESUME_LIST',
    DRAFT_DELETE_LIST: 'DRAFT_DELETE_LIST',
    DISCARD_CLAIM_CONFIRM: 'DISCARD_CLAIM_CONFIRM',
    QUERY_BOT: 'QUERY_BOT',
    PREMIUM_CALCULATOR: 'PREMIUM_CALCULATOR',
    HELPER_PHONE_CAPTURE: 'HELPER_PHONE_CAPTURE',
    HELPER_OTP_VERIFY: 'HELPER_OTP_VERIFY',
    OPERATOR_HANDOFF: 'OPERATOR_HANDOFF',
    APPEAL_START: 'APPEAL_START',
    ERROR_RECOVERY: 'ERROR_RECOVERY',
    // Transitional aliases for older claim records or stale sessions.
    LOSS_REPORT_START: 'CLAIM_FARMER_DETAILS',
    CROP_DETAILS: 'CLAIM_CROP_DETAILS',
    DATE_LOCATION: 'CLAIM_DATE_LOCATION',
    DOCUMENT_INTAKE: 'CLAIM_DOCUMENTS',
    TEMPLATE_SELECT: 'CLAIM_TEMPLATE_SELECT',
    SCHEMA_COLLECTION: 'CLAIM_MISSING_FIELDS',
    PHOTO_EVIDENCE: 'CLAIM_PHOTOS',
    REVIEW_CONFIRM: 'CLAIM_REVIEW',
    TRACK_STATUS: 'STATUS_LIST',
    APPEAL_FLOW: 'APPEAL_START',
    HELPER_MODE: 'HELPER_PHONE_CAPTURE',
    OPERATOR_BRIDGE: 'OPERATOR_HANDOFF',
